...
const AboutUs = ()=>{
    return (
        ...
        <div className="w-full items-center justify-center p-36 mt-auto text-center mt-1/4">
           ...
           <div className="text-5xl">MeowIV Homes has been selling and buying homes for more than 20 years. We are proud to be one of the top realty companies in our city. </div>
         </div>
